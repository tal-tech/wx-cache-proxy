...
#define FIRST_REDIS_LAST_MQ 1
#define FIRST_MQ_LAST_REDIS 2

#define  CONSUME_LOCAL_PROCESS 1
#define  CONSUME_PEER_PROCESS 2 
...
struct instance {
    ...
    char             *etcd_conf_filename;     /*etcd conf filename */
    char             *mq_conf_filename;     /*mq conf filename */
    int    mq_consume_worker_num; /*consume mq worker num*/
    int    environment_type; /*twemrproxy environment type*/
    char            *trace_conf_filename;
};
...
extern struct worker_info* core_worker_list;
//extern pid_t *core_worker_list;

extern int core_worker_num;
extern int core_is_master;
