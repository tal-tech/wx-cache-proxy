...
#define MSG_TYPE_CODEC(ACTION)                                                                      \
    ...
    ACTION( REQ_REDIS_SELECT_CLIENT)           /*client send select */                                                               \
    ...
    ACTION( SENTINEL )                                                                              \
    ACTION( REQ_REDIS_SET_SLOW_THRESHOLD)                                                                              \
...
struct msg {
    ...
    uint64_t              recv_client_time;
    uint64_t              send_server_time;
    uint64_t              recv_server_time;
    uint64_t              send_client_time;
};
